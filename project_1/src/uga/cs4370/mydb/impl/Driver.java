...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        // students datatable
        Relation stu = rb.newRelation("Students", Arrays.asList("StudentID", "FName", "LName", "DoB", "Major"),
        ...
        // courses datatable
        Relation cou = rb.newRelation("Courses", Arrays.asList("CourseID", "CName", "Credits"),
        ...
        Relation enr = rb.newRelation("Enrollment", Arrays.asList("EnrollmentID", "StudentID", "CourseID", "grade"),
        ...
        Relation pro = rb.newRelation("Professors", Arrays.asList("ProfessorID", "FName", "LName", "department"),
        ...
        // teaches datatable
        Relation tea = rb.newRelation("Teaches", Arrays.asList("TeachID", "ProfessorID", "CourseID"),
        ...
        System.out.println("Q3: Retrieve all course names a student with ID 1234 has enrolled in: ");
        finalQ3.print();
        ...
        System.out.println("Q4: List of professor names and IDs who teach courses of more than 2 credits");
        finalQ4.print();
        ...
        Predicate predex5 = new Predicate() {
            ...
            public boolean check(List<Cell> row) {
                ...
                return !enr.getRows().stream().anyMatch(enrollmentRow -> {
        ...
        System.out.println("Q5: Students who have not enrolled in any course: ");
        finalQ5.print();
        ...
        Relation project_q8c = ra.project(nat_join_q8c, Arrays.asList("FName", "LName", "ProfessorID"));
